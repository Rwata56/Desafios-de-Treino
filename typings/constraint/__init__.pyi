...
import copy
import doctest
from .version import __author__, __copyright__, __credits__, __email__, __license__, __status__, __url__, __version__
...
class Problem:
    ...
    def getSolutionIter(self): # -> Iterator[Never] | Generator[dict[Any, Any], Any, None]:
        """
...
class BacktrackingSolver(Solver):
    ...
    def getSolutionIter(self, domains, constraints, vconstraints): # -> Generator[dict[Any, Any], Any, None]:
        ...
    
    def getSolution(self, domains, constraints, vconstraints): # -> dict[Any, Any] | None:
        ...
    
    def getSolutions(self, domains, constraints, vconstraints): # -> list[dict[Any, Any]]:
        ...
...
class Constraint:
    ...
    """
    def __call__(self, variables, domains, assignments, forwardcheck=...): # -> Literal[True]:
        """
    ...
    def preProcess(self, variables, domains, constraints, vconstraints): # -> None:
        """
    ...
    def forwardCheck(self, variables, domains, assignments, _unassigned=...): # -> bool:
        """
...
class FunctionConstraint(Constraint):
    ...
    def __call__(self, variables, domains, assignments, forwardcheck=..., _unassigned=...): # -> bool:
        ...
...
class MaxSumConstraint(Constraint):
    ...
    def __call__(self, variables, domains, assignments, forwardcheck=...): # -> bool:
        ...
