...
from desafios_de_treino.rail_fence_cipher import decode, encode


class RailFenceCipherTest(unittest.TestCase):
    def test_encode_with_one_rails(self):
        self.assertMultiLineEqual(encode("XOXOXOXOXOXOXOXOXO", 1), "XOXOXOXOXOXOXOXOXO")
    ...
    def test_encode_hello_world_with_three_rails(self):
        self.assertMultiLineEqual(encode("HELLOWORLD", 3), "HOLELWRDLO")

    def test_decode_hello_world_with_three_rails(self):
        self.assertMultiLineEqual(decode("HORELWLDLO", 3), "HELLOWOLRD")
